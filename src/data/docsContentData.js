...
const contentData = {
  home: {
              ...
              items: [
                {
                  ...
                  lines: [
                    "Carefully read through the EULA to understand your rights and responsibilities when using MyPet Health's platform.",
                  ],
                },
                {
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              // heading: "Sample: Updating Your Legal Profile",
              imageSrcs: [
                "https://firebasestorage.googleapis.com/v0/b/vetcationapp.appspot.com/o/website%2FIMG_1547.webp?alt=media&token=ff683eff-1056-4f6b-ba65-ef2b26ea3288",
    ...
    ViewingYourUpcomingAppointments: {
      ...
      mainDescription: `MyPet Health's scheduling system is designed to make managing your appointments as easy as possible.
    ...
    VideoCall: {
      ...
      mainDescription: `MyPet Health's telemedicine system is designed to help you provide high-quality virtual consultations with ease.
      ...
      sections: [
        {
          ...
          blocks: [
            {
              type: "qa",
              question: "How does MyPet Health's telemedicine system work?",
              answer:
                "MyPet Health's telemedicine system allows you to conduct video calls with clients, share medical records, and manage prescriptions in a secure and compliant environment. You can document your consultations, ensuring that you have a complete record of each appointment.",
            },
            {
              type: "framedImage",
              // heading: "Sample: Updating Your Legal Profile",
    ...
    earnings: {
      ...
      mainDescription: `MyPet Health's earnings and wallet system is designed to help you manage your income from virtual consultations effectively.
    ...
    how MyPet Health's features help veterinary professionals comply with each requirement 
          ...
          blocks: [
            {
              ...
              helpText:
                ...
                " MyPet Health's records to demonstrate compliance.",
            },
          ],
        },
...
requirements and explain how MyPet Health keeps you compliant.`,
      ...
      `,
              helpText:
                "MyPet Health's note template maps one-to-one with each § 2032.3(a) item and prevents closure of a consult until all required fields are completed.",
            },
          ],
        },
        {
      ...
      `,
              helpText:
                "MyPet Health's >Export → Generate Summary tool auto-pulls every § 2032.3(b) element, inserts your e-signature, and produces a PDF. The timer ensures delivery within five days (or sooner if you mark the case critical).",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              ...
              example:
                ...
                "</ul>",
              helpText:
                "MyPet Health's scheduling and location checks block new telehealth bookings when the system detects the pet is outside California, ensuring only appropriately-licensed veterinarians can see the patient.",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              ...
              helpText:
                "MyPet Health's platform includes documentation prompts to note 'telehealth insufficient, recommended in-person exam.' This ensures transparency in your medical record if the Board later reviews why you referred the animal for in-person care.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
           ...
           <li>Your website footer shows: Dr. Jane Doe, DVM #12345; “For medical records requests, email records@example.com”; “Call the CA Veterinary Medical Board at (916) 515-5220 for questions.”</li>
              ...
              helpText:
                "MyPet Health's onboarding checks each § 4853(h) condition. If any fail, we guide you through submitting a premises-registration application to the Board—ensuring full compliance with state law.",
            },
          ],
        },
        {
    ...
    joinVideoCall: {
      ...
      mainDescription: `
          MyPet Health's video consultation feature enables you to meet clients 
    ...
    videoCallFeatures: {
      ...
      mainDescription: `
          MyPet Health's call interface offers more than a basic camera and microphone. 
...
<a href="https://bmcvetres.biomedcentral.com/articles/10.1186/s12917-015-0514-6" target="_blank" rel="noopener noreferrer">ICADA guideline (2015 update)</a>`,
  ...
  shelters: {
    shelterIntroToVetcation: {
      mainTitle: "Introduction for Shelters and Rescue Organizations",
      mainDescription: `MyPet Health helps shelters and rescue organizations support adopters after they bring their pets home. Give every adopted pet a lifelong digital medical record, connect adopters with your partnered veterinarians for telehealth support, and create a new support stream for your mission. The platform is free for shelters, requires no downloads, and fits seamlessly into your existing workflow.`,
      sections: [
        {
          id: "missionForShelters",
          title: "Our Mission for Shelters",
          blocks: [
            {
              type: "paragraph",
              text: `Shelters do incredible work preparing pets for adoption, but support often ends once the pet goes home. Adopters may have questions, struggle to access care, or lose important medical records, which can lead to confusion, unnecessary stress, and avoidable returns.`,
            },
            {
              type: "root",
              helpText: `MyPet Health extends your support beyond adoption day. We help shelters provide adopters with a lifelong medical record and a trusted path to follow-up care through telehealth. At the same time, we create a new support stream for shelters and make it easier for veterinarians who want to contribute to animal welfare to support your adopters remotely.`,
            },
          ],
        },

        {
          id: "achieveForShelters",
          title: "What Can Your Organization Achieve with MyPet Health?",
          blocks: [
            {
              type: "paragraph",
            ...
            },
            {
              ...
              items: [
                {
                  heading: "Give every pet a lifelong medical record:",
                  lines: [
                    "Start each adopted pet with a centralized digital medical record that stays with them for life.",
                    "Eliminate lost paperwork and make it easy for adopters to share records with future clinics and ER teams.",
                  ],
                },
                {
                  heading: "Offer trusted post-adoption telehealth support:",
                  lines: [
                    "Partner with veterinarians who can support your adopters remotely through messaging and virtual visits.",
                    "Ensure adopters have a clear path to follow-up care after they go home.",
                  ],
                },
                {
                  heading: "Reduce post-adoption workload:",
                  lines: [
                    "Minimize follow-up phone calls and repeated questions by giving adopters direct access to veterinary support.",
                    "Keep communication organized within the platform instead of relying on manual callbacks.",
                  ],
                },
                {
                  heading: "Create a new support stream for your mission:",
                  lines: [
                    "When adopters use telehealth services, a portion of the platform fee is allocated back to your organization.",
                    "Generate ongoing support without additional fundraising efforts.",
                  ],
                },
                {
                  heading: "Enable veterinarians to support your adopters:",
                  lines: [
                    "Work with veterinarians who are interested in contributing to animal welfare.",
                    "Remove geographic limitations by enabling remote telehealth support.",
                  ],
                },
                {
                  heading: "Free and easy to adopt:",
                  lines: [
                    "No cost for shelters and no app download required for your staff.",
                    "Create pet profiles, upload records, and transfer ownership in minutes.",
                  ],
                },
              ],
            },
        ...
        {
          id: "whyThisMattersForShelters",
          title: "Why Post-Adoption Support Matters",
          blocks: [
            {
              type: "trendPoints",
              introParagraphs: [
                "Adoption is just the beginning of a pet’s journey. Many challenges happen after pets go home, and improving post-adoption support can significantly impact long-term outcomes:",
              ],
              items: [
                {
                  heading: "Adopters need guidance after adoption:",
                  lines: [
                    "New pet owners often have questions about behavior, health, and care in the first few weeks.",
                    "Without clear support, uncertainty can lead to stress and poor decision-making.",
                  ],
                },
                {
                  heading: "Medical record fragmentation is common:",
                  lines: [
                    "Paper records are easily lost or incomplete, making it harder for future veterinarians to understand a pet’s history.",
                  ],
                },
                {
                  heading: "Limited access to veterinary care:",
                  lines: [
                    "Many adopters face delays in getting appointments or are unsure when care is needed.",
                    "Telehealth provides a faster, more accessible first step.",
                  ],
                },
                {
                  heading: "Better support reduces returns:",
                  lines: [
                    "Providing guidance and access to care after adoption helps improve confidence and reduces the likelihood of pets being returned.",
                  ],
                },
              ],
            },
  ...
  clinics: {
    ...
    VirtualBranch: {
      mainTitle: "Set Up Your Virtual Branch with MyPet Health",
    ...
    //     {
    //       id: "referralNetwork",
    //       title: "MyPet Health's Referral Clinic Network",
    //       blocks: [
    //         {
    //           type: "paragraph",
    //           text: "MyPet Health's Referral Clinic Network is designed to connect virtual veterinarians with local clinics that can provide in-person care. This network allows pet owners to receive timely and appropriate care while ensuring that clinics have the opportunity to support their community.",
    //         },
    //         {
    //           type: "map",
    ...
    //               lines: [
    //                 "MyPet Health's workflows align with California’s telehealth rules — reducing audit risk and paperwork.",
    //               ],
    //             },
    //           ],
    //         },
  ...
  clients: {
    ...
    // setting up MyPet Health, we will show 1. choose your role as a pet owner. 2. set up your profile.
    settingUpVetcation: {
      mainTitle: "Setting Up MyPet Health",
